...
<html lang="en">
  ...
  <body>
    ...
    <div style="border:0px solid #e5e5e5;border-radius:5px; padding-left:10px; padding-right:10px;">
	  ...
	  <form action="login_attendance2.php" method="post">
           <center> <h4>Time Log In</h4></center>
            <p><div class="col-sm-3"></div><center> <div class="col-sm-5">
			<input  name="employee_id" class="form-control" id="focusedInput" type="text" value="" placeholder="username">
			<input  name="date" class="form-control"  id="focusedInput" type="date" value="" placeholder="username">
			<button type="submit" class="btn btn-primary PULL-RIGHT " name="save" value="Save">Save</button></div><div class="col-sm-3"></div></center></em> </p>
            <p>  <em></em></p>
			</form> 
...
$timelog=("select * from attendance where date='$date' and employee_id='$employee'");

$admin=$mysqli->num_rows($timelog);
